# contact-lead-contract Specification

## Purpose
TBD - created by archiving change fix-contact-form-contract. Update Purpose after archive.
## Requirements
...
and `docs/data-model.md`. Required fields (`name`, `email`, `phone`, `message`) MUST be
enforced. The `contact_preference` field is OPTIONAL and MUST NOT be required in the UI.
